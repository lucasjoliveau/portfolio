!function (t, e) {
    ...
    var d = {
            ...
            return o(e, [{
                ...
                key: "detectElements", value: function (i) {
                    var s = this, n = this.instance.scroll.y, o = n + this.windowHeight;
    ...
    var y = t(function (t, e) {
                        ...
                        a.scroll = a.scrollTo = function () {
                            ...
                            if (!0 !== s(arguments[0])) {
                                var t = function (t) {
                                    ...
                                    var e, i, s;
                                    return t
                                }(this), e = t.getBoundingClientRect(), i = this.getBoundingClientRect();
            ...
            return l(i, f), o(i, [{
                ...
                key: "addElements", value: function () {
                    ...
                    this.els = [], this.el.querySelectorAll("[data-" + this.name + "]").forEach(function (t, e) {
                        var i = t.dataset[h.name + "Class"] || h.class,
                            ...
                            l = t.dataset[h.name + "Repeat"], r = t.dataset[h.name + "Call"];
                        l = "false" != l && (null != l || h.repeat);
                        var a = h.getRelativeOffset(o), c = {
                            el: t,
                            id: e,
                            class: i,
                            top: s + a[0],
                ...
                key: "updateElements", value: function () {
                    var o = this;
                    this.els.forEach(function (t, e) {
                        var i = t.el.getBoundingClientRect().top + o.instance.scroll.y, s = i + t.el.offsetHeight,
        ...
        }()), g = Object.getOwnPropertySymbols, w = Object.prototype.hasOwnProperty,
    ...
    }, D = Object.prototype.toString, L = Object.prototype.hasOwnProperty;
    ...
    var M = T.Lethargy, C = "virtualscroll", x = R, B = 37, H = 38, j = 39, Y = 40, A = 32;
    ...
    var V = 4, F = 1e-7, W = 10, q = "function" == typeof Float32Array;
    ...
    var J = function (o, e, l, i) {
        ...
        function s(t) {
            ...
            var s = e + .1 * ((t - r[--i]) / (r[i + 1] - r[i])), n = $(s, o, l);
    ...
    }, Q = 38, Z = 40, tt = 32, et = 9, it = 33, st = 34, nt = 36, ot = 35, lt = function (t) {
        function n() {
            var t, e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
        ...
        return l(n, f), o(n, [{
            ...
            key: "addElements", value: function () {
                ...
                this.els = [], this.parallaxElements = [], this.sections.forEach(function (t, S) {
                    k.sections[S].el.querySelectorAll("[data-".concat(k.name, "]")).forEach(function (t, e) {
                        var i, s, n = t.dataset[k.name + "Class"] || k.class, o = t.dataset[k.name + "Repeat"],
                            l = t.dataset[k.name + "Call"], r = t.dataset[k.name + "Position"],
                            a = t.dataset[k.name + "Delay"], c = t.dataset[k.name + "Direction"],
                        ...
                        var p = (i = k.sections[S].inView ? s.getBoundingClientRect().top + k.instance.scroll.y - X(s).y : s.getBoundingClientRect().top - X(k.sections[S].el).y - X(s).y) + s.offsetHeight,
                            y = (p - i) / 2 + i;
                        if (h) {
                            var v = t.getBoundingClientRect().top, m = v - i;
            ...
            key: "transform", value: function (t, e, i, s) {
                var n;
                if (s) {
                    var o = X(t), l = P(o.x, e, s), r = P(o.y, i, s);
            ...
            key: "transformElements", value: function (s) {
                var n = this, o = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                    l = this.instance.scroll.y + this.windowHeight, r = this.instance.scroll.y + this.windowMiddle;
            ...
            key: "scrollTo", value: function (t, e) {
                var i, s = this, n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 1e3,
                    o = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : [.25, 0, .35, 1],
                    l = 4 < arguments.length && void 0 !== arguments[4] && arguments[4],
                    r = 5 < arguments.length ? arguments[5] : void 0, a = e ? parseInt(e) : 0;
                ...
                if ("number" != typeof i) {
                    ...
                    var c = i.getBoundingClientRect().top, h = I(i).find(function (e) {
                ...
                var d = parseFloat(this.instance.delta.y), f = Math.max(0, Math.min(a, this.instance.limit)) - d,
                    p = function (t) {
